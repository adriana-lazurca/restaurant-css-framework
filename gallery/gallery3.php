            ...
            <div class="col-12 mt-4">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item active"><a class="page-link" href="./gallery3.php">3</a></li>
        ...
        <div container-img>
            <div class="row">
                <div class="col-12 col-sm-offset-1 col-sm-10 col-md-4 img-container mb-1 mx-auto">
                    <img src="./gallery/oatmeal.jpg" alt="oatmeal">
                </div>
                <div class="col-12 col-sm-offset-1 col-sm-10 col-md-4 img-container mb-1 mx-auto">
                    <img src="./gallery/coffee_machine.jpg" alt="coffee_machine">
                </div>
                <div class="col-12 col-sm-offset-1 col-sm-10 col-md-4 img-container mb-1 mx-auto">
                    <img src="./gallery/coffee1.jpg" alt="coffee1">
                </div>
            </div>
        </div>
